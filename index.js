...
function clickRight() {
  ...
  switch(newValue){
    case -270:
      ...
      document.querySelector('.project1-container').setAttribute("aria-hiden","true");
      document.querySelector('.project4').removeAttribute("tabindex")
      document.querySelector('.project4-container').removeAttribute("aria-hiden");
      break;
    case -540:
      document.querySelector('.project2').setAttribute("tabindex","-1");
      document.querySelector('.project2-container').setAttribute("aria-hiden","true");
      document.querySelector('.project5').removeAttribute("tabindex")
      document.querySelector('.project5-container').removeAttribute("aria-hiden");
      break;
    default:
      break;
    }
...
function clickLeft() {
  ...
  switch(newValue){
    case -270:
      ...
      document.querySelector('.project5-container').setAttribute("aria-hiden","true");
      document.querySelector('.project2').removeAttribute("tabindex")
      document.querySelector('.project2-container').removeAttribute("aria-hiden");
      break;
    case 0:
      document.querySelector('.project4').setAttribute("tabindex","-1");
      document.querySelector('.project4-container').setAttribute("aria-hiden","true");
      document.querySelector('.project1').removeAttribute("tabindex")
      document.querySelector('.project1-container').removeAttribute("aria-hiden");
      break;
    default:
      break;
    }
